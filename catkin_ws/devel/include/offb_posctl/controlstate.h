...
bool operator==(const ::offb_posctl::controlstate_<ContainerAllocator1> & lhs, const ::offb_posctl::controlstate_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.discrepointpersecond == rhs.discrepointpersecond &&
    lhs.inicounter == rhs.inicounter &&
    lhs.arraylength == rhs.arraylength &&
    lhs.wall_z == rhs.wall_z &&
    lhs.wall_y == rhs.wall_y &&
    lhs.parabolictime == rhs.parabolictime &&
    lhs.thrustarray == rhs.thrustarray &&
    lhs.tauarray == rhs.tauarray &&
    lhs.phiarray == rhs.phiarray &&
    lhs.thetaarray == rhs.thetaarray &&
    lhs.stateXarray == rhs.stateXarray &&
    lhs.stateYarray == rhs.stateYarray &&
    lhs.stateZarray == rhs.stateZarray &&
    lhs.stateVXarray == rhs.stateVXarray &&
    lhs.stateVYarray == rhs.stateVYarray &&
    lhs.stateVZarray == rhs.stateVZarray &&
    lhs.stateAXarray == rhs.stateAXarray &&
    lhs.stateAYarray == rhs.stateAYarray &&
    lhs.stateAZarray == rhs.stateAZarray;
}
